<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TableDesign.aspx.cs" Inherits="faz1.TableOperations.TableDesign" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:TextBox runat="server" ID="xx"></asp:TextBox>
    <div id="myyModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h3 runat="server" id="H1">Tablo Adı</h3>
        </div>
        <div class="modal-body">

            <div class="row-fluid">
                <div class="span6">
                    <label>Eski Tablo Düzeni</label>
                    <asp:GridView OnRowDataBound="grdEski_RowDataBound" CssClass="table-bordered" AutoGenerateColumns="true" ID="grdEski" runat="server">
                        
                    </asp:GridView>
                </div>

                <div class="span6">
                    <label>Yeni Tablo Düzeni</label>
                    <asp:GridView OnRowDataBound="grdYeni_RowDataBound" CssClass="table-bordered" ID="grdYeni" runat="server"></asp:GridView>
                </div>
            </div>
            ...
            <div class="modal-footer">
                ...
                <asp:Button Style="height: auto" Text="Kolon Ekle" ClientIDMode="static" ID="Button1" OnClick="addColumn_Click" CssClass="btn btn-success" runat="server" />
            </div>
        </div>
        ...
        <div class="span11 offset2" style="width: 75%">
            <div class="panel panel-primary ">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            ...
                            <asp:Panel Visible="false" ID="pnlAlter" runat="server">
                                <asp:Button Style="float: right" Text="Tabloyu Sil" OnClientClick="return deleteTable();" ID="btnDeleteTable" OnClick="btnDeleteTable_Click" CssClass="btn btn-danger" runat="server" />
                            ...
                            <asp:GridView AutoGenerateColumns="false" ID="grdModifyTable" CssClass="table table-bordered" runat="server"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Düzen">
                                        ...
                                        <EditItemTemplate>
                                            <asp:LinkButton CssClass="btn btn-success" Text="Güncelle" runat="server" CommandName="Update" />
                                    ...
                                    <asp:TemplateField HeaderText="Kolon Adı">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txt_KolonAd" ToolTip="Kolon Adı" ClientIDMode="static" Style="border-color: red;" runat="server" Width="80px" Text='<%#Eval("COLUMN_NAME") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                ...
                <div runat="server" id="pnlFooter" visible="false" class="panel-footer">
                    <br />
                    <asp:Button Visible="false" Style="float: right" Text="Vazgeç" ID="btnDontSave" OnClick="btnDontSave_Click" CssClass="btn btn-danger" runat="server" />
                    <asp:Button Visible="false" OnClientClick="SaveChanges();" Style="float: right; margin-right: 5px;" ID="btnAlter" OnClick="btnAlter_Click" Text="Değişiklikleri Kaydet" CssClass="btn btn-success" runat="server" />
                    <a href="#myyModal" id="btnPreview" runat="server" style="float: right; margin-right: 5px; padding: 9px;" role="button" class="btn btn-info" data-toggle="modal">Tabloya Kolon Ekle</a>
